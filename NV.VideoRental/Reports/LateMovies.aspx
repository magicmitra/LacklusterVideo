...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT v.* FROM [video] [v] JOIN [rental] [r] ON [v].[videoID] = [r].[videoID] WHERE [v].[active] = 1 AND [v].[rented] = 1"></asp:SqlDataSource>
&nbsp;</asp:content>
